...
class Maze(tk.Tk, object):
    ...
    def step(self, action):
        ...
        elif next_coords in [self.canvas.coords(self.hell1), self.canvas.coords(self.hell2), self.canvas.coords(self.hell3), self.canvas.coords(self.hell4)]:
            reward = -1
            print("defeat")
            done = True
        else:
    ...
    def __build_maze(self):
        ...
        self.hell2 = self.canvas.create_rectangle(
            ...
            hell2_center[0] + 15, hell2_center[1] + 15,
            fill='black')
        hell3_center = origin + np.array([0, UNIT])
        self.hell3 = self.canvas.create_rectangle(
            hell3_center[0] - 15, hell3_center[1] - 15,
            hell3_center[0] + 15, hell3_center[1] + 15,
            fill='black')
        hell4_center = origin + np.array([0, UNIT*2])
        ...
        oval_center = origin + np.array([3*UNIT, 0*UNIT])
        self.oval = self.canvas.create_oval(
            oval_center[0] - 15, oval_center[1] - 15,
            oval_center[0] + 15, oval_center[1] + 15,
            fill='yellow')
